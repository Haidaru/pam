...
//    // Update Admin Data
//    @PutMapping("/update")
//    public ResponseEntity<Object> updateAdmin(@Valid @RequestBody Admin admin, BindingResult bindingResult) {
//        if (bindingResult.hasErrors()) {
//            // Handle validation errors
//            String validationErrorMessage = bindingResult.getAllErrors()
//                    .stream()
...
//        }
//
//        return handleUpdateAdminResponse(() -> adminService.updateAdmin(admin));
//    }
//    // Handle the response for updateAdmin
//    private ResponseEntity<Object> handleUpdateAdminResponse(Supplier<String> action) {
//        try {
...
//        return handleDeleteAdminResponse(() -> adminService.deleteAdmin(id));
//    }
//
//    private ResponseEntity<Object> handleDeleteAdminResponse(Supplier<String> action) {
//        try {
//            String result = action.get();
//
